...
import { 
  ...
  Heart, Share2, BookOpen, Clock, 
  Smartphone, VolumeX, Leaf 
} from 'lucide-react';
...
const CONTENT = {
  id: {
    hero: {
      ...
      subhead: "Jurnal Ramadan yang fokus pada ketenangan hati, bukan sekadar mengejar target angka.",
      cta_primary: "Mulai Sekarang",
      cta_secondary: "Lihat Preview",
      trust: ["PWA Offline", "Tanpa Iklan", "Privasi Aman"],
    ...
    day_flow: {
      ...
      steps: [
        { time: "Pagi", title: "Niat & Fokus", desc: "Satu kutipan penyemangat saat sahur." },
        { time: "Siang", title: "Tracker Ringan", desc: "Checklist simpel di sela kesibukan." },
        { time: "Sore", title: "Jelang Berbuka", desc: "Hitung mundur & doa harian." },
        { time: "Malam", title: "Refleksi", desc: "Jurnal syukur sebelum tidur." }
      ]
    },
    features: {
      1: { title: "Waktu Sholat & Imsak", desc: "Otomatis sesuai lokasi, tanpa suara bising default." },
      2: { title: "Dzikir Counter", desc: "Tap area luas, getaran lembut, reset harian otomatis." },
      3: { title: "Target Tadarus", desc: "Progress bar visual yang tidak mengintimidasi." },
      4: { title: "Koleksi Doa", desc: "Bookmark doa-doa favorit untuk dibaca cepat." },
      5: { title: "Mode Offline", desc: "Tetap lancar saat sinyal susah atau mode pesawat." },
      6: { title: "Kartu Refleksi", desc: "Bagikan momen bermakna dengan desain estetik." }
    },
    streak: {
    ...
    privacy: {
      ...
      bullets: ["Mode Tamu (Tanpa Login)", "Sinkronisasi Opsional", "Tidak Ada Pelacakan Iklan"],
      cta: "Baca Manifesto Data"
    },
    faq: {
      title: "Pertanyaan Umum",
      items: [
        { q: "Apakah aplikasi ini gratis?", a: "100% Gratis dan open source. Tanpa fitur berbayar." },
        { q: "Perlu login?", a: "Tidak. Anda bisa menggunakan Mode Tamu selamanya." },
        { q: "Bisa dipakai offline?", a: "Ya, ini adalah PWA. Bisa diinstal dan jalan tanpa internet." },
        { q: "Tanggal Ramadan bisa diubah?", a: "Ya, Anda bisa menyesuaikan tanggal 1 Ramadan manual." },
        { q: "Apakah data saya aman?", a: "Data tersimpan di HP Anda (local storage) kecuali Anda login." }
      ]
    },
    final: {
    ...
    testimonials: [
      { t: "Akhirnya ada app yang nggak bikin merasa bersalah kalau lupa isi.", u: "Rina, Jakarta" },
      { t: "Tampilannya adem banget di mata pas bangun sahur.", u: "Dimas, Bandung" },
      { t: "Simpel, to the point, gak berat di HP kentang.", u: "Fauzan, Jogja" }
    ]
  },
  en: {
    hero: {
      ...
      subhead: "A Ramadan journal focused on peace of heart, not just chasing numbers.",
    ...
    problem: {
      ...
      points: [
        ...
        { t: "Competitive", d: "Worship feels like a burden due to leaderboards." }
      ]
    },
    promise: {
      title: "Our Promise",
    ...
    day_flow: {
      title: "A Day With Us",
      steps: [
        { time: "Morning", title: "Intention", desc: "One uplifting quote at Suhoor." },
        { time: "Noon", title: "Light Tracker", desc: "Simple checklist between tasks." },
        { time: "Evening", title: "Pre-Maghrib", desc: "Countdown & daily prayers." },
        { time: "Night", title: "Reflection", desc: "Gratitude journal before sleep." }
      ]
    },
    features: {
      1: { title: "Prayer & Imsak", desc: "Auto-location, no loud default sounds." },
      2: { title: "Dhikr Counter", desc: "Large tap area, haptic feedback, auto-daily reset." },
      3: { title: "Quran Goals", desc: "Visual progress bar that doesn't intimidate." },
      4: { title: "Prayer Collection", desc: "Bookmark favorite Duas for quick access." },
      5: { title: "Offline Mode", desc: "Smooth even with bad signal or airplane mode." },
      6: { title: "Reflection Cards", desc: "Share meaningful moments with aesthetic design." }
    },
    streak: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Works offline?", a: "Yes, it's a PWA. Installs and runs without internet." },
        { q: "Change Ramadan date?", a: "Yes, you can manually adjust the start date." },
        { q: "Is my data safe?", a: "Data is stored on your phone (local storage) unless you login." }
      ]
    },
    final: {
    ...
    testimonials: [
      { t: "Finally an app that doesn't make me feel guilty.", u: "Rina, Jakarta" },
      { t: "The interface is so soothing for my eyes at Suhoor.", u: "Dimas, Bandung" },
...
const Lantern = ({ delay = 0, x = "10%", scale = 1, duration = 6 }) => {
  return (
    ...
    >
      ...
      >
        <svg width="48" height="72" viewBox="0 0 48 72" fill="none" className="drop-shadow-[0_0_20px_rgba(251,191,36,0.4)]">
          <path d="M12 8 H36 L38 16 H10 Z" fill="#92400e" />
          <path d="M10 16 C8 24 6 40 6 48 C6 60 12 68 24 68 C36 68 42 60 42 48 C42 40 40 24 38 16 Z" fill="url(#lanternGradient)" fillOpacity="0.6" stroke="#d97706" strokeWidth="1.5" />
          <ellipse cx="24" cy="40" rx="10" ry="16" fill="#fbbf24" fillOpacity="0.4" />
          <path d="M20 68 L24 76 L28 68" fill="#92400e" />
          <defs>
            <linearGradient id="lanternGradient" x1="24" y1="16" x2="24" y2="68" gradientUnits="userSpaceOnUse">
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 overflow-x-hidden font-sans">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm text-slate-300 mb-6 backdrop-blur-sm"
          >
            <motion.span
          ...
          >
            {(t('hero.trust') as string[]).map((item, i) => (
              <span key={i} className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 bg-emerald-500/60 rounded-full" /> {item}
              </span>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-20 px-6">
        ...
        >
          <p className="text-amber-400/80 text-sm tracking-widest uppercase mb-4 text-center">{t('problem.title')}</p>
        ...
        >
          ...
          <p className="text-amber-400/80 text-sm tracking-widest uppercase mb-4">{t('promise.title')}</p>
      ...
      <section id="preview" className="py-20">
        ...
        >
          <p className="text-amber-400/80 text-sm tracking-widest uppercase mb-2">Experience Peace</p>
      ...
      <section className="py-20 px-6">
        <p className="text-amber-400/80 text-sm tracking-widest uppercase mb-8 text-center">{t('day_flow.title')}</p>
          ...
          {(t('day_flow.steps') as any[]).map((step, i) => (
            ...
            >
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                <p className="text-amber-400 text-xs uppercase tracking-wider mb-2">{step.time}</p>
                <p className="font-serif text-lg text-white mb-2">{step.title}</p>
              ...
              {i < 3 && <div className="hidden md:block absolute top-1/2 -right-3 w-6 h-px bg-gradient-to-r from-white/10 to-transparent" />}
            </motion.div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 relative">
            ...
            >
                ...
                {[...Array(7)].map((_, i) => (
                  <div
                    ...
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                      i < 5 ? 'bg-amber-500/20 text-amber-400' : 'bg-white/5 text-slate-500'
                    }`}
                  >
                    {i + 1}
                  </div>
              ...
              <p className="font-serif text-xl text-white mb-2">{t('streak.title')}</p>
            ...
            >
              ...
              <p className="font-serif text-xl text-white mb-2">{t('reminders.title')}</p>
              <p className="text-sm text-slate-400 mb-4">{t('reminders.desc')}</p>
      ...
      <section className="py-20 px-6 text-center">
        ...
        <p className="font-serif text-2xl md:text-3xl text-white mb-8">{t('privacy.title')}</p>
        <div className="flex flex-wrap items-center justify-center gap-4 mb-8">
          {(t('privacy.bullets') as string[]).map((b, i) => (
            <span key={i} className="px-4 py-2 bg-white/5 rounded-full text-sm text-slate-300 border border-white/5">
              {b}
            </span>
          ))}
        </div>
        <button className="text-sm text-amber-400 hover:underline">{t('privacy.cta')}</button>
      </section>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6">
          {(t('testimonials') as any[]).map((tm, i) => (
            ...
            >
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">{tm.t}</p>
      ...
      {/* --- SECTION 11: FAQ --- */}
      <section className="py-20 px-6">
        <p className="font-serif text-2xl text-white text-center mb-12">{t('faq.title')}</p>
      ...
      <footer className="py-12 px-6 border-t border-white/5">
        ...
        <p className="text-center text-xs text-slate-600">© {new Date().getFullYear()} MyRamadhanKu. Open Source Project.</p>
      </footer>
